...
from .detect import eval_detection_voc
...
def voc_evaluation(dataset, predictions, output_dir, iteration=None):
    ...
    for i in range(len(dataset)):
        ...
        prediction['boxes'][:, 0::2] *= (img_info['width'] / 300)
        prediction['boxes'][:, 1::2] *= (img_info['height'] / 300)
        boxes, labels, scores = prediction['boxes'], prediction[
